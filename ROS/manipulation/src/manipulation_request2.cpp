...
int main(int argc, char *argv[])
{
    ...
    srv.request.manipulation_plan_request.task_type = manipulation::ManipulationPlanRequest::POUR;
    srv.request.manipulation_plan_request.task_name = "pour";
    srv.request.manipulation_plan_request.target_object_name = "Cup";
    // Call the service
    if (client.call(srv))
    {
